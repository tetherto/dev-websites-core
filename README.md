...
site's environment** (`.env` / hosting / CI); `@wdk/core` never defines them.
...
import { buildCmsConfig, createS3MediaPlugin } from '@wdk/core/cms'
import { mongooseAdapter } from '@payloadcms/db-mongodb'
import sharp from 'sharp'
import { Languages } from '@wdk/core/i18n'
